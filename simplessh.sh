#!/bin/bash
#	Name:							SimpleSSH
#	Title							IST193 Final Project
#	Creater:						Joel Carlton
#	Date:							12/08/11
#	Version:						1.3
#	Purpose: 						SimpleSSH was designed to take the effort out of port forwarding,
#									binding ports, and forwarding X11."
#	Release Notes:
#
#	Version			#Date			#Notes
